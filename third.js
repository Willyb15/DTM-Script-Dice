...
var SeekerID = _satellite.getVar('Seeker ID');
var dtpjobid = _satellite.getVar('Jobid');
var seekerNumber = _satellite.getVar("Seeker Number");
var userId = _satellite.getVar("DTM_UserId");
...
if (server == "uk") {
  ...
  window.criteo_q.push(
    ...
    { event: "setHashedEmail", email: _satellite.getVar('SSDL - User - Emailhash') },
    { event: "setSiteType", type: deviceType },
    { event: "trackTransaction" , id: dtpjobid + ':' + userId, 
            item: [ { 
                id: dtpjobid,
              	price: 0,
                quantity: "1" 
